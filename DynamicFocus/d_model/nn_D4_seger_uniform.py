...
class SegerUniform(nn.Module):
    ...
    def forward(self, x_BxCxHxW: torch.Tensor, x_Bx2: torch.Tensor, x_ds_BxCxHSxWS: torch.Tensor = None):
        ...
        x_ds_rgbf_BxC1xHSxWS[:, :-1, :, :] = x_ds_BxCxHSxWS if x_ds_BxCxHSxWS is not None else self.downsample_x_real_BxCxHSxWS(x_BxCxHxW)
        # assign focus map
